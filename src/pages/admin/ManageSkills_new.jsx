...
const emptyForm = { name: '', category: 'Languages', level: 'Intermediate' };
          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleSave} className="space-y-4">
              <div>
                ...
                <input className="form-input" type="text" placeholder="e.g. React"
              ...
              <div className="flex gap-3">
                <button type="submit" disabled={saving} className="btn-gradient flex-1">
                  {saving ? 'Saving...' : modal === 'add' ? 'Add Skill' : 'Update Skill'}
                </button>
